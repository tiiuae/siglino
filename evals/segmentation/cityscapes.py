...
def main():
    ...
    test_loss, test_miou = evaluate_cityscapes(seg_model, test_loader, criterion, num_classes=args.num_classes, ignore_index=args.ignore_index, device=device)
    ...
    print(f"BEST_VAL_MIOU: {best_miou:.4f} @ epoch {best_epoch} | TEST_MIOU: {test_miou:.4f}")
